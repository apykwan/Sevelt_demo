...
<SectionWrapper>
  ...
  >
    <h2
      class="text-semibold text-5xl sm:text-6xl md:text-7xl lg:text-8xl max-w-[1200px] mx-auto w-full text-center"
    >
    ...
    <p
      class="text-xl sm:text-2xl med:text-3xl text-center max-w-[1000px] mx-auto w-full"
    >
      Less thinking & more doing. We're the trianer in your pocket full of
      <span class="italic">
