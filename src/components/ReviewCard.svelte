...
<div
  class={`flex flex-col gap-2 w-full max-w-[500px] mx-auto relative ${isLeftExist}`}
>
  <div class="flex relative">
    <div
      class={`absolute rounded-full bg-white aspect-square hidden md:grid place-items-center ${isIndexEven}`}
    >
